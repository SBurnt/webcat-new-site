...
class SendMailSmtpClass
{
  ...
  public function __construct($smtp_username = 'info@1bank.by', $smtp_password = 'bank19010', $smtp_host = 'mail.1bank.by', $smtp_from = '1bank', $smtp_port = 25, $smtp_charset = "utf-8")
  {
